...
//////////////////////////
$stateProvider.state("login",{url:"/?msg",templateUrl:"views/login.html",controller:function($scope,$rootScope,$state,$filter,$timeout){$scope.clickLogin=function(e){e.preventDefault(),console.log($state),$scope.msg=$state.params.msg}}}).state("students",{url:"/admin/students",auth:"admin",templateUrl:"views/students.html",
// auth: true,
/*resolve: {
